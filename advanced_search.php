...
*/
  ...
  $breadcrumb->add(Translate('Geavanceerd zoeken'), tep_href_link(FILENAME_ADVANCED_SEARCH));
?>
    ...
    <td width="100%" valign="top"><?php echo tep_draw_form('advanced_search', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get', 'onSubmit="return check_form(this);"') . tep_hide_session_id(); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo Translate('Geavanceerd zoeken'); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
<?php
  ...
  $info_box_contents[] = array('align' => 'right', 'text' => tep_draw_checkbox_field('search_in_description', '1') . ' ' . Translate('Zoek in productomschrijving'));
...
?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="smallText" align="right"><div class="button-a" title="<?php echo Translate('Zoeken'); ?>"><span><input type="submit" value="<?php echo Translate('Zoeken'); ?>" class="formbutton button-a"/></span></div></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="fieldKey"><?php echo Translate('Categorieën'); ?></td>
                <td class="fieldValue"><?php echo tep_draw_pull_down_menu('categories_id', tep_get_categories(array(array('id' => '', 'text' => Translate('Alle categorieën'))))); ?></td>
              </tr>
              <tr>
                <td class="fieldKey">&nbsp;</td>
                <td class="smallText"><?php echo tep_draw_checkbox_field('inc_subcat', '1', true) . ' ' . Translate('Inclusief subcategorieën'); ?></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
              </tr>
              <tr>
                <td class="fieldKey"><?php echo Translate('Fabrikanten'); ?></td>
                <td class="fieldValue"><?php echo tep_draw_pull_down_menu('manufacturers_id', tep_get_manufacturers(array(array('id' => '', 'text' => Translate('Alle fabrikanten'))))); ?></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
              </tr>
              <tr>
                <td class="fieldKey"><?php echo Translate('Prijs vanaf'); ?></td>
                <td class="fieldValue"><?php echo tep_draw_input_field('pfrom'); ?></td>
              </tr>
              <tr>
                <td class="fieldKey"><?php echo Translate('Prijs tot'); ?></td>
              ...
              <tr>
                <td class="fieldKey"><?php echo Translate('Datum vanaf'); ?></td>
              ...
              <tr>
                <td class="fieldKey"><?php echo Translate('Datum tot'); ?></td>
