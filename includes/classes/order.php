...
*/
  ...
  class order {
    ...
    function query($order_id) {
      ...
      $order_query = tep_db_query("select customers_id, customers_name, customers_company, customers_street_address, customers_suburb, customers_city, customers_postcode, customers_state, customers_country, customers_telephone, customers_email_address, customers_address_format_id, delivery_name, delivery_company, delivery_street_address, delivery_suburb, delivery_city, delivery_postcode, delivery_state, delivery_country, delivery_address_format_id, billing_name, billing_company, billing_street_address, billing_suburb, billing_city, billing_postcode, billing_state, billing_country, billing_address_format_id, payment_method, cc_type, cc_owner, cc_number, cc_expires, currency, currency_value, date_purchased, orders_status, last_modified, billing_tva_intracom from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
      ...
      $order_comment_query = tep_db_query("select comments from " . TABLE_ORDERS_STATUS_HISTORY . " where orders_id = '".(int)$order_id."'");
      ...
      $this->billing = array('name' => $order['billing_name'],
                             ...
                             'billing_tva_intracom' => array('title' => $order['billing_tva_intracom']),
    ...
    function cart() {
      ...
      if (is_array($billto) && !empty($billto)) {
        $billing_address = array('entry_firstname' => $billto['firstname'],
                                 ...
                                 'billing_tva_intracom' => $customer_address['billing_tva_intracom'],
      ...
      $this->billing = array('firstname' => $billing_address['entry_firstname'],
                             ...
                             'billing_tva_intracom' => $billing_address['billing_tva_intracom'],
