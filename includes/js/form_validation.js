...
$(document).ready(function(){
	...
	updateSubmitButton();
	$('input:not(:hidden), select, textarea').change(function() {validate($(this), true);updateSubmitButton();});
	$('input:not(:hidden), select, textarea').blur(function() {validate($(this), true);updateSubmitButton();});
