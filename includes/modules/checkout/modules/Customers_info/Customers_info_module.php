                ...
                foreach($block_data['fields'] as $field=>$field_data) {
                    ...
                    if ($show_field) {
                        ...
                        if ($field_data['type'] == 'dropdown') {
                            ...
                            } else if ($field_data['name'] == 'billing_lastname') {
                                if (isset($_POST[get_class($this).'_'.$field])) {
                            ...
                            } else if ($field_data['name'] == 'delivery_firstname') {
                                if (isset($_POST[get_class($this).'_'.$field])) {
                            ...
                            } else if ($field_data['name'] == 'delivery_lastname') {
                                if (isset($_POST[get_class($this).'_'.$field])) {
...
////////////////////////////////////////////////////////////////* #1539 - Shipping address
	}else if(($field_data['name'] == 'delivery_telephone') && ($to['delivery_telephone'] == '')){
