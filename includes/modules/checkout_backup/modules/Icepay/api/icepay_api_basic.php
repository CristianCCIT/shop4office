...
class Icepay_Api_Basic {
    ...
    */
    ...
    /**
    * Filter the paymentmethods array by status
    * @since version 1.0.0
    * @access public
    * @param string $language Language ISO 639-1 code
    */
...
class Icepay_Basicmode implements Icepay_Basicmode_Interface_Abstract {
    ...
    */
    public function getURL(){
        if (!isset($this->_merchantID)) throw new Exception(Translate('Merchant ID niet ingesteld, gebruik de setMerchantID() methode'));
        if (!isset($this->_secretCode)) throw new Exception(Translate('Merchant ID niet ingesteld, gebruik de setSecretCode() methode'));
        ...
        if (!isset($this->data->ic_issuer) && $this->_method != null){
            ...
            } else throw new Exception(Translate('Issuer niet ingesteld, gebruik de setIssuer() methode'));
        }
        if (!isset($this->data->ic_language)){
            if (count($this->_language) == 1) {
                $this->data->ic_language = $this->_language[0];
            } else throw new Exception(Translate('Taal niet ingesteld, gebruik de setLanguage() methode'));
        }
        if (!isset($this->data->ic_currency)){
            if (count($this->_currency) == 1) {
                $this->data->ic_currency = $this->_currency[0];
            } else throw new Exception(Translate('Valuta is niet ingesteld, gebruik de setCurrency() methode'));
        }
        if (!isset($this->data->ic_amount))     throw new Exception(Translate('Bedrag niet ingesteld, gebruik de setAmount() methode'));
        if (!isset($this->data->ic_orderid))    throw new Exception(Translate('OrderID niet ingesteld, gebruik de setOrderID() methode'));
    ...
    */
    protected function postRequest( $url, $data ){
            ...
            curl_close($ch);
            if ( !$response ) throw new Exception(sprintf(Translate("Fout bij het lezen van %s"), $url));
    ...
    */
    public function setIssuer($issuer){
		if (!isset($this->_issuer[$issuer]) && $this->_method != null) {
...
class Icepay_Postback extends Icepay_Basicmode {
    ...
    */
    public function validate() {
        ...
        $this->data->statusCode = (isset($_POST['StatusCode'])) ? $_POST['StatusCode'] : "";
        $this->data->merchant = (isset($_POST['Merchant'])) ? $_POST['Merchant'] : "";
        $this->data->orderID = (isset($_POST['OrderID'])) ? $_POST['OrderID'] : "";
        $this->data->paymentID = (isset($_POST['PaymentID'])) ? $_POST['PaymentID'] : "";
        $this->data->reference = (isset($_POST['Reference'])) ? $_POST['Reference'] : "";
        $this->data->transactionID = (isset($_POST['TransactionID'])) ? $_POST['TransactionID'] : "";
        $this->data->consumerName = (isset($_POST['ConsumerName'])) ? $_POST['ConsumerName'] : "";
        $this->data->consumerAccountNumber = (isset($_POST['ConsumerAccountNumber'])) ? $_POST['ConsumerAccountNumber'] : "";
        $this->data->consumerAddress = (isset($_POST['ConsumerAddress'])) ? $_POST['ConsumerAddress'] : "";
        $this->data->consumerHouseNumber = (isset($_POST['ConsumerHouseNumber'])) ? $_POST['ConsumerHouseNumber'] : "";
        $this->data->consumerCity = (isset($_POST['ConsumerCity'])) ? $_POST['ConsumerCity'] : "";
        $this->data->consumerCountry = (isset($_POST['ConsumerCountry'])) ? $_POST['ConsumerCountry'] : "";
        $this->data->consumerEmail = (isset($_POST['ConsumerEmail'])) ? $_POST['ConsumerEmail'] : "";
        $this->data->consumerPhoneNumber = (isset($_POST['ConsumerPhoneNumber'])) ? $_POST['ConsumerPhoneNumber'] : "";
        $this->data->consumerIPAddress = (isset($_POST['ConsumerIPAddress'])) ? $_POST['ConsumerIPAddress'] : "";
        $this->data->amount = (isset($_POST['Amount'])) ? $_POST['Amount'] : "";
        $this->data->currency = (isset($_POST['Currency'])) ? $_POST['Currency'] : "";
        $this->data->duration = (isset($_POST['Duration'])) ? $_POST['Duration'] : "";
        $this->data->paymentMethod = (isset($_POST['PaymentMethod'])) ? $_POST['PaymentMethod'] : "";
        $this->data->checksum = (isset($_POST['Checksum'])) ? $_POST['Checksum'] : "";
    ...
    */
    public function canUpdateStatus($currentStatus) {
        ...
        switch ($this->data->status) {
            case Icepay_StatusCode::SUCCESS:       return ($currentStatus == Icepay_StatusCode::SUCCESS);
            case Icepay_StatusCode::OPEN:          return ($currentStatus == Icepay_StatusCode::OPEN);
            case Icepay_StatusCode::ERROR:         return ($currentStatus == Icepay_StatusCode::ERROR);
            case Icepay_StatusCode::CHARGEBACK:    return ($currentStatus == Icepay_StatusCode::CHARGEBACK);
            case Icepay_StatusCode::REFUND:        return ($currentStatus == Icepay_StatusCode::REFUND);
            default:
                return false;
        };
    }
