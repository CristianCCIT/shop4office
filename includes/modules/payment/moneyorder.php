...
// class constructor
    function moneyorder() {
      ...
      $this->title = Translate('Vooruit betalen');
      $this->description = sprintf(Translate('Betaal aan:<br>%s<br />%s<br />%s '.STORE_CITY.'<br />Tel.: %s<br />BTW: %s<br />Je bestelling wordt verwerkt zodra wij jouw betaling ontvangen hebben op ons rekening nr %s'), STORE_NAME, STORE_STREET_ADDRESS, STORE_POSTCODE, STORE_TELEPHONE, STORE_BTW, STORE_REKENINGNR);
      ...
      $this->email_footer = sprintf(Translate('Betaal aan:<br>%s<br />%s<br />%s '.STORE_CITY.'<br />Tel.: %s<br />BTW: %s<br />Je bestelling wordt verwerkt zodra wij jouw betaling ontvangen hebben op ons rekening nr %s'), STORE_NAME, STORE_STREET_ADDRESS, STORE_POSTCODE, STORE_TELEPHONE, STORE_BTW, STORE_REKENINGNR);
    }
...
// class methods
    ...
    function confirmation() {
      return array('title' => sprintf(Translate('Betaal aan:<br>%s<br />%s<br />%s '.STORE_CITY.'<br />Tel.: %s<br />BTW: %s<br />Je bestelling wordt verwerkt zodra wij jouw betaling ontvangen hebben op ons rekening nr %s'), STORE_NAME, STORE_STREET_ADDRESS, STORE_POSTCODE, STORE_TELEPHONE, STORE_BTW, STORE_REKENINGNR));
    }
