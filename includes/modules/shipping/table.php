...
// class constructor
    function table() {
      ...
      $this->code = 'table';
      $this->title = Translate('table titel');
      $this->description = Translate('table omschrijving');
...
// class methods
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            'module' => Translate('table titel'),
                            'methods' => array(array('id' => $this->code,
                                                     'title' => Translate('tabel omschrijving'),
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Handling Fee', 'MODULE_SHIPPING_TABLE_HANDLING', '0', 'Handling fee for this shipping method.', '40', '0', now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_TABLE_SORT_ORDER', '21', 'Sort order of display.', '40', '0', now())");
    }
