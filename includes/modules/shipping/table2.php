<?php
/*
  $Id: table2.php 1739 2007-12-20 00:52:16Z hpdl $
...
// class constructor
    function table2() {
      ...
      $this->code = 'table2';
      $this->title = Translate('table2 titel');
      $this->description = Translate('table2 omschrijvig');
      ...
      if ( ($this->enabled == true) && ((int)MODULE_SHIPPING_TABLE2_ZONE > 0) ) {
        $check_flag = false;
        $check_query = tep_db_query("select zone_id from " . TABLE2_ZONES_TO_GEO_ZONES . " where geo_zone_id = '" . MODULE_SHIPPING_TABLE2_ZONE . "' and zone_country_id = '" . $order->delivery['country']['id'] . "' order by zone_id");
...
// class methods
    function quote($method = '') {
      ...
      $table2_cost = preg_split("/[:,]/" , MODULE_SHIPPING_TABLE2_COST);
      ...
      $this->quotes = array('id' => $this->code,
                            'module' => Translate('table2 titel'),
                            'methods' => array(array('id' => $this->code,
                                                     'title' => Translate('table2 omschrijving'),
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Handling Fee', 'MODULE_SHIPPING_TABLE2_HANDLING', '0', 'Handling fee for this shipping method.', '40', '0', now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_TABLE2_SORT_ORDER', '22', 'Sort order of display.', '40', '0', now())");
    }
